...
namespace \NielsHoppe\RDFDAV\CalDAV\Backend;
 ...
 * ARC2 CalDAV backend
 *
 * This backend is used to store calendar-data in a ARC2 triplestore.
 *
 * @copyright Copyright (C) Niels Hoppe (http://nielshoppe.de/)
 * @author Niels Hoppe (http://nielshoppe.de/)
 * @license http://sabre.io/license/ Modified BSD License
 */
class ARC extends AbstractBackend implements
    SyncSupport,
    SubscriptionSupport
    //SchedulingSupport,
    //SharingSupport
